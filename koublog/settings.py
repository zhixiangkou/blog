"""
Django settings for koublog project.
...
SECRET_KEY = '@^5aa%8*%(*(7q1*e*gq0-6(kiprtp74ca_z(llwyjt4rk@!4j'
...
WSGI_APPLICATION = 'koublog.wsgi.application'
